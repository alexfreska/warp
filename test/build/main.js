...
function WarpMainThreadManager() {
  ...
  // console.log(WarpApplicationThreadManager)
  ...
  $(function () {
    ...
    var m = new Worker("build/warp-worker.bundle.js");
     ...
     */
    var eventMap = {};
    var rootNode = vd.create(vd.h('div', {}, [String(0)]));
    ...
    m.onmessage = function (e) {
      ...
      // patch
      e.data.patch && console.log(e.data.patch);
      e.data.patch && (rootNode = vd.patch(rootNode, e.data.patch));
    };
