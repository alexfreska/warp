...
function createWorker(func, vDOM) {
...
function createFuncBlobWithVDOM(func, vDOM) {
  ...
  console.log(arr);
  return URL.createObjectURL(new Blob([].concat(_toConsumableArray(arr), ['(', func.toString(), ')()']), { type: 'application/javascript' }));
}
...
var Events = exports.Events = {
  ...
  getString: function getString() {
    return "blur change click dblclick error focus focusin focusout hover keydown keypress keyup load mousedown mouseenter mouseleave mousemove mouseout mouseover mouseup resize scroll select submit";
  }
};
...
var _warpMain = require('./warp-main');

(0, _warpMain.WarpMainThreadManager)();

},{"./warp-main":40}],40:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.WarpMainThreadManager = WarpMainThreadManager;

var _createWorker = require('./create-worker');

var _warpWorker = require('./warp-worker');

var _events = require('./events');

var _virtualDom = require('virtual-dom');

var vd = _interopRequireWildcard(_virtualDom);
...
function WarpMainThreadManager() {
   ...
   */
  var m = (0, _createWorker.createWorker)(_warpWorker.WarpApplicationThreadManager, vd);

  /**
   * requires constants
   */
  var events = _events.Events.getString();
  ...
  $(function () {
    $('body').on(events, function (e) {
      ...
      wid && eventMap[wid] && eventMap[wid][e.type] && m.postMessage({ event: e.type, wid: wid });
    });
  });
}

},{"./create-worker":37,"./events":38,"./warp-worker":41,"jquery":2,"virtual-dom":6}],41:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.WarpApplicationThreadManager = WarpApplicationThreadManager;
function WarpApplicationThreadManager(vd) {
  ...
  onmessage = function (e) {
    ...
    d.event && eventSubMap[d.wid] && eventSubMap[d.wid][d.event]();
    return;
  };
